object LearningScala1 {
  ...
  val hello: String = "mama!"                     //> hello  : String = mama!
  println(hello)                                  //> mama!
  ...
  var helloThere: String = hello                  //> helloThere  : String = mama!
  helloThere = hello + " There!"
  println(helloThere)                             //> mama! There!
  ...
  val immutableHelloThere = hello + "There!"      //> immutableHelloThere  : String = mama!There!
  println(immutableHelloThere)                    //> mama!There!
